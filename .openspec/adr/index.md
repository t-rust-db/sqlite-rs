...
| [0043](0043-sqlgrep-serverless-trigram-cache.md) | `sqlgrep`: a serverless trigram grep over a per-root db-storage cache file (amends ADR-0040's third-party clause) | 2026-09-08 |
