...
**Implementation:** `db-storage:src/row/btree/mod.rs`

**Tests:** inline `#[cfg(test)]` in `db-storage:src/row/btree/mod.rs`
...
**Tests:** `db-storage:src/row/btree/mod.rs::page_one_trap_sqlite_master_root_is_page_one`
...
**Tests:** `db-storage:src/row/btree/mod.rs::table_multipage_full_scan_matches_oracle`
...
**Tests:** `db-storage:src/row/btree/mod.rs::table_multipage_seek_matches_oracle`
...
**Tests:** `db-storage:src/row/btree/mod.rs::overflow_single_page_payload_is_byte_identical_to_oracle`
...
**Tests:** `db-storage:src/row/btree/mod.rs::overflow_multi_page_payload_is_byte_identical_to_oracle`
...
**Tests:** inline `#[cfg(test)]` in `db-storage:src/row/btree/mod.rs`; `tests/fuzz/fuzz_targets/btree_cursor.rs`
...
**Tests:** `db-storage:src/row/btree/mod.rs::truncated_page_errors_not_panics`, `db-storage:src/row/btree/mod.rs::unexpected_page_type_errors_not_panics`, `db-storage:src/row/btree/index.rs::truncated_page_errors_not_panics`, `db-storage:src/row/btree/index.rs::unexpected_page_type_errors_not_panics`
...
**Tests:** `db-storage:src/row/btree/mod.rs::overflow_chain_hitting_page_zero_early_errors_not_panics`
...
**Implementation:** `db-storage:src/row/btree/mod.rs` (module doc's rowid-alias note)
...
**Tests:** `db-storage:src/row/btree/mod.rs::rowid_alias_column_decodes_as_null_not_substituted`
...
Substitution landed via #34 (DDL reader)'s `rowid_alias_from_sql`/`TableSchema::rowid_alias`, now wired through `db-core:src/codegen/row/select/projection.rs`, `db-core:src/codegen/row/stmt/insert.rs`, and `db-core:src/codegen/row/stmt/update.rs` — this requirement's original "(planned)" note was stale; the two scenarios above are both discharged.
...
**Implementation:** `db-storage:src/row/btree/index.rs`

**Tests:** inline `#[cfg(test)]` in `db-storage:src/row/btree/index.rs`
...
**Tests:** `db-storage:src/row/btree/index.rs::secondary_index_walk_matches_oracle_binary_order`
...
**Tests:** `db-storage:src/row/btree/index.rs::truncated_page_errors_not_panics`, `db-storage:src/row/btree/index.rs::unexpected_page_type_errors_not_panics`
...
**Tests:** `db-storage:src/row/btree/index.rs::secondary_index_seek_matches_oracle`
...
**Implementation:** `db-storage:src/row/btree/mod.rs::local_payload_size` (takes an `is_index` flag); `tools/gen_fixtures.sh` (`overflow_index_key.db`)
...
**Implementation:** `db-storage:src/row/btree/table/insert.rs::insert_into_leaf`, `db-storage:src/row/btree/table/insert.rs::encode_leaf_cell`
...
**Tests:** `db-storage:src/row/btree/table/insert.rs::tests::duplicate_rowid_is_rejected`
...
**Implementation:** `db-storage:src/row/btree/table/insert.rs::insert_into_leaf`, `db-storage:src/row/btree/table/insert.rs::insert_into_parent`
...
**Implementation:** `db-storage:src/row/btree/table/insert.rs::insert_into_parent`
...
**Implementation:** `db-storage:src/row/btree/table/insert.rs::root_split`
...
**Implementation:** `db-storage:src/row/btree/table/delete.rs::delete_row`
...
**Tests:** `db-storage:src/row/btree/table/delete.rs::tests::deleting_a_missing_rowid_errors`
...
**Tests:** `db-storage:src/row/btree/table/delete.rs::tests::deleting_one_of_two_rows_keeps_the_other`, `tests/corpus/btree_delete_test.rs::delete_single_row_from_a_two_row_leaf`
...
**Implementation:** `db-storage:src/row/btree/table/delete.rs::collapse_into_ancestors`
...
**Tests:** `db-storage:src/row/btree/table/delete.rs::tests::deleting_the_only_row_leaves_an_empty_root_leaf`
...
**Implementation:** `db-storage:src/row/btree/table/delete.rs::collapse_into_ancestors`, `db-storage:src/row/btree/table/delete.rs::collapse_root`
...
**Tests:** `db-storage:src/row/btree/index/insert.rs::tests::duplicate_key_is_rejected`
...
**Implementation:** `db-storage:src/row/btree/index/delete.rs::delete_entry`, `db-storage:src/row/btree/index/delete.rs::delete_from_leaf`
...
**Tests:** `db-storage:src/row/btree/index/delete.rs::tests::deleting_a_missing_key_errors`
...
**Tests:** `db-storage:src/row/btree/index/delete.rs::tests::deleting_an_entry_with_overflow_frees_its_overflow_chain`, `db-storage:src/row/btree/index/delete.rs::tests::deleting_all_entries_orphans_no_page`
...
**Implementation:** `db-storage:src/row/btree/index/delete.rs::delete_via_predecessor_swap`, `db-storage:src/row/btree/index/delete.rs::extract_max_entry`
...
**Tests:** `db-storage:src/row/btree/index/delete.rs::tests::minimal_two_entry_split_then_delete_promoted_key`
...
**Tests:** `db-storage:src/row/btree/index/delete.rs::tests::split_then_delete_all_including_promoted_interior_entries`
...
**Implementation:** `db-storage:src/row/integrity.rs::run_integrity_check`, `db-core:src/vm/row/vm.rs::integrity_check`, `db-core:src/codegen/row/pragma.rs::compile_pragma`, `db-core:src/parser/ast.rs::Pragma::IntegrityCheck`
...
**Tests:** `db-core:src/codegen/row/pragma.rs::tests::integrity_check_compiles_p1_zero`, `db-core:src/codegen/row/pragma.rs::tests::quick_check_compiles_p1_one`
