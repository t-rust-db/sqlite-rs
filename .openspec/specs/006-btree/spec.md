...
**Implementation:** `db-storage:src/row/integrity.rs::run_integrity_check`, `db-core:src/vm/row/vm.rs::integrity_check`, `src/codegen/pragma.rs::compile_pragma`, `db-core:src/parser/row/ast.rs::Pragma::IntegrityCheck`
